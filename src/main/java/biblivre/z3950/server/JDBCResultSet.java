...
public class JDBCResultSet extends AbstractIRResultSet implements IRResultSet {
    ...
    public InformationFragment[] getFragment(
            int starting_fragment, int count, RecordFormatSpecification spec)
    ...
    public IRResultSetInfo getResultSetInfo() {
        return new IRResultSetInfo(
                getResultSetName(), "JDBC", null, getFragmentCount(), getStatus(), null);
    }
}
