...
public class UserFieldService {
  ...
  public UserFieldDTO createUserFieldWithTranslations(
    ...
    logger.info("Creating user field '{}' with translations for {} languages",
        userField.getKey(), fieldNameTranslations.size());
  ...
  private void persistFieldNameTranslations(String fieldKey, Map<String, String> translations) {
    ...
    for (Map.Entry<String, String> entry : translations.entrySet()) {
      ...
      logger.debug("Adding translation for field '{}' in language '{}': '{}'",
          fieldKey, language, translatedName);
   ...
   */
  @Transactional
  public void updateFieldTranslations(String fieldKey, Map<String, String> fieldNameTranslations) {
    logger.info("Updating translations for user field '{}' with {} languages",
        fieldKey, fieldNameTranslations.size());
