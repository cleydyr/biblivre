...
public class Update implements UpdateService {
    ...
    public void doUpdate(Connection connection) {
        ...
        Translations.addSingleTranslation(
                "pt-BR",
                "cataloging.bibliographic.search.holding_id",
        ...
        Translations.addSingleTranslation(
                "en-US", "cataloging.bibliographic.search.holding_id", "Label barcode number");
        ...
        Translations.addSingleTranslation(
                "es", "circulation.lending.no_holding_found", "Ningún ejemplar encontrado");
    }
