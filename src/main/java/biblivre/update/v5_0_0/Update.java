...
public class Update implements UpdateService {
    ...
    public void doUpdate(Connection connection) {
        ...
        Translations.addSingleTranslation(
                "pt-BR",
                "administration.brief_customization.separators.dot-space",
                "Ponto - espaço");
        ...
        Translations.addSingleTranslation(
                "pt-BR",
                "administration.brief_customization.authorities",
        ...
        Translations.addSingleTranslation(
                "pt-BR",
                "administration.brief_customization.vocabulary",
        ...
        Translations.addSingleTranslation(
                "es", "administration.form_customization.subfield_autocomplete.", "Autocompletar");
    ...
    private void _updateSortOrderForTableWithSubfield(String tableName, Connection con)
            throws SQLException {
