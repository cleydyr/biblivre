...
public enum AuthorizationPointTypes {
    LOGIN(
            ...
            AuthorizationPointGroups.LOGIN,
            true),
    ...
    CIRCULATION_LIST(
            AuthorizationSchemaScope.SINGLE_SCHEMA,
            AuthorizationUserScope.EMPLOYEE,
            AuthorizationPointGroups.CIRCULATION),
    CIRCULATION_SAVE(
            AuthorizationSchemaScope.SINGLE_SCHEMA,
            AuthorizationUserScope.EMPLOYEE,
            AuthorizationPointGroups.CIRCULATION),
    ...
    CIRCULATION_RESERVATION_RESERVE(
            ...
            AuthorizationUserScope.EMPLOYEE,
            AuthorizationPointGroups.CIRCULATION),
    CIRCULATION_ACCESS_CONTROL_LIST(
            AuthorizationSchemaScope.SINGLE_SCHEMA,
            AuthorizationUserScope.EMPLOYEE,
            AuthorizationPointGroups.CIRCULATION),
    CIRCULATION_ACCESS_CONTROL_BIND(
            AuthorizationSchemaScope.SINGLE_SCHEMA,
            AuthorizationUserScope.EMPLOYEE,
            AuthorizationPointGroups.CIRCULATION),
    CIRCULATION_PRINT_USER_CARDS(
            AuthorizationSchemaScope.SINGLE_SCHEMA,
            AuthorizationUserScope.EMPLOYEE,
            AuthorizationPointGroups.CIRCULATION),
    ...
    CIRCULATION_USER_RESERVATION(
            AuthorizationSchemaScope.SINGLE_SCHEMA,
            AuthorizationUserScope.READER,
            AuthorizationPointGroups.CIRCULATION),

    ACQUISITION_SUPPLIER_LIST(
            AuthorizationSchemaScope.SINGLE_SCHEMA,
            AuthorizationUserScope.EMPLOYEE,
            AuthorizationPointGroups.ACQUISITION),
    ...
    ADMINISTRATION_MULTI_SCHEMA(
            AuthorizationSchemaScope.GLOBAL_SCHEMA,
            AuthorizationUserScope.EMPLOYEE,
            AuthorizationPointGroups.ADMIN),
