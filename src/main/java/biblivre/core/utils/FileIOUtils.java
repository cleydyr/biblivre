...
public class FileIOUtils {
    ...
    public static void sendHttpFile(
        ...
        if (file != null) {
            ...
            // If-Unmodified-Since header should be greater than LastModified. If not, then return
            // 412.
            ...
            if (range != null) {
                ...
                if (ifRange != null && !ifRange.equals(eTag)) {
                    try {
                        long ifRangeTime =
                                request.getDateHeader("If-Range"); // Throws IAE if invalid.
            ...
            if (contentType.startsWith("text")) {
                ...
                disposition =
                        accept != null && FileIOUtils.accepts(accept, contentType)
                                ? "inline"
                                : "attachment";
            }
            ...
            try (file;
                ...
                if (ranges.isEmpty() || ranges.get(0) == full) {
                    ...
                    response.setContentType(
                            "multipart/byteranges; boundary=" + Constants.MULTIPART_BOUNDARY);
                    response.setStatus(HttpServletResponse.SC_PARTIAL_CONTENT); // 206.
