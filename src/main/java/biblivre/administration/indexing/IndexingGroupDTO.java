...
/**
 * Class that defines the format used to index records by a group of datafields. E.g.: Authors will
...
public class IndexingGroupDTO extends AbstractDTO {
    ...
    /**
     * List of DataFields and their respective SubFields E.g.: [{ "100": ['a', 'b', 'c'] }, { "110":
     * ['a', 'b', 'c'] }, { "111": ['a', 'b', 'c'] }]
     */
