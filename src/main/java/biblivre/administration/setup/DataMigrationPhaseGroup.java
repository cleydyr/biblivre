...
public enum DataMigrationPhaseGroup implements BiblivreEnum {
    ...
    CATALOGING_BIBLIOGRAPHIC(
            DataMigrationPhase.CATALOGING_BIBLIOGRAPHIC, DataMigrationPhase.CATALOGING_HOLDINGS),
    ...
    ACQUISITION(
            DataMigrationPhase.ACQUISITION_SUPPLIER,
            DataMigrationPhase.ACQUISITION_REQUISITION,
    ...
    ACCESS_CONTROL(
            ...
            DataMigrationPhase.ACCESS_CONTROL_HISTORY),
    LENDINGS(
            DataMigrationPhase.LENDINGS,
            DataMigrationPhase.LENDINGS_HISTORY,
            DataMigrationPhase.LENDING_FINE),
