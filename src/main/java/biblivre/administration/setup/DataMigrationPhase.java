...
public enum DataMigrationPhase implements BiblivreEnum {
    ...
    CATALOGING_AUTHORITIES(
            "cataloging_authorities", "authorities_records", "authorities_records_id_seq", "id"),
    CATALOGING_VOCABULARY(
            "cataloging_vocabulary", "vocabulary_records", "vocabulary_records_id_seq", "id"),
    ...
    ACQUISITION_ITEM_QUOTATION(
            "acquisition_item_quotation", "request_quotation", "quotations_id_seq", null),
    ...
    private DataMigrationPhase(
            ...
            String biblivre4TableName,
            String biblivre4SequenceName,
            String biblivre4IdColumnName) {
