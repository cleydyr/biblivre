...
public class ReportApiDelegateImpl implements ReportApiDelegate {
  ...
  public ResponseEntity<List<RestReport>> getReports() {
    ...
    List<RestReport> restReports = reports.stream().map(ReportApiDelegateImpl::getReport).toList();
  ...
  private List<RestReportParameter> toRestReportParameters(Collection<ReportParameter> parameters) {
