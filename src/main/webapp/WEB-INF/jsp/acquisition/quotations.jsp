...
<layout:head>
	...
	<static:stylesheet fileName="biblivre.acquisition.css" />

	<static:script fileName="biblivre.search.js" />
	<static:script fileName="biblivre.acquisition.quotation.search.js" />
	<static:script fileName="biblivre.input.js" />
	<static:script fileName="biblivre.acquisition.quotation.input.js" />
