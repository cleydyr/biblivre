...
<body>
	<form id="page_submit" name="page_submit" method="post"
		${isMultiPart ? pageScope.multiPartAttributes : pageScope.notMultiPartAttribute}>
						...
						<c:otherwise>
							<c:choose>
								<c:when test="${isEmployee or isLogged}">
									<c:forEach var="entry" items="${sessionScope.modules}">
		...
		<div id=notifications>
			<div id=messages>
				...
				<c:if test="${flagsProvider.isFlagEnabled('new-interface')}">
					<div class="message success alpha_interface_banner">
						<div>
							🎉 Experimente nossa nova interface com usabilidade aprimorada!
							<a href="${spaHref}" class="fright">
