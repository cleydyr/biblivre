...
<layout:head>
	...
	<script type="text/javascript" src="resources/scripts/biblivre.acquisition.order.search.js"></script>
	<script type="text/javascript" src="resources/scripts/biblivre.input.js"></script>
	<script type="text/javascript" src="resources/scripts/biblivre.acquisition.order.input.js"></script>
