...
<layout:head>
	...
	<script type="text/javascript" src="resources/scripts/biblivre.acquisition.supplier.search.js"></script>
	<script type="text/javascript" src="resources/scripts/biblivre.input.js"></script>
	<script type="text/javascript" src="resources/scripts/biblivre.acquisition.supplier.input.js"></script>
