...
<layout:body>
	<div class="page_help"><i18n:text key="search.authorities.page_help" param1="<%= IndexingGroups.getSearchableGroupsText(RecordType.AUTHORITIES, (String) request.getAttribute(\"language\")) %>" /></div>
