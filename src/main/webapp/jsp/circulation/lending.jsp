...
<layout:head>
	...
	<script type="text/javascript" src="resources/scripts/biblivre.holding.search.js"></script>
	<script type="text/javascript" src="resources/scripts/biblivre.circulation.lending.js"></script>
