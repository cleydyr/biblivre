...
<layout:head>
	...
	<script type="text/javascript" src="resources/scripts/biblivre.circulation.input.js"></script>
	...
	<script type="text/javascript" src="resources/scripts/jquery.imgareaselect.js"></script>
...
<layout:body>
	...
	<div id="circulation_user">
		...
		<textarea class="selected_highlight_template template"><!--
			...
			{#else}
				<img class="user_photo" src="resources/images/photo.png"/>
			{#/if}
			<div class="record">
